...
For Lobotomy to properly implement its dependencies, a Homebrew installation of Python is required for OS X and [LinuxBrew](http://linuxbrew.sh/) for Linux distributions.  
